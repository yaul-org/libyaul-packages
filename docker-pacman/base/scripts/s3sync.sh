...
/usr/sbin/s3cmd sync --follow-symlinks --delete-removed --acl-public "${BUILD_BASEPATH}/s3/${SYNC_PATH}/" "s3://packages.yaul.org/${SYNC_PATH}/" || { panic "Unable to sync directory" 1; }
}
